!(function () {
  ...
  var l = function (r) {
    ...
    r = (function () {
      try {
        for (
          var r = Number(process.env.IT_TREATMENT || 0),
            e = JSON.parse(process.env.IT_ALLOW || "{}"),
            t = JSON.parse(process.env.IT_BLOCK || "{}"),
            u = (function (r) {
              var e = {},
                t = [];
              if (
                (r._bizo_data_partner_id &&
                  ((e[r._bizo_data_partner_id] = !0),
                  t.push(r._bizo_data_partner_id)),
                r._bizo_data_partner_ids)
              )
                for (var u = 0, n = r._bizo_data_partner_ids; u < n.length; u++)
                  !e[(a = n[u])] && l(a) && ((e[a] = !0), t.push(a));
              if (
                (r._linkedin_data_partner_id &&
                  !e[r._linkedin_data_partner_id] &&
                  ((e[r._linkedin_data_partner_id] = !0),
                  t.push(r._linkedin_data_partner_id)),
                r._linkedin_data_partner_ids)
              )
                for (
                  var a, i = 0, s = r._linkedin_data_partner_ids;
                  i < s.length;
                  i++
                )
                  !e[(a = s[i])] && l(a) && ((e[a] = !0), t.push(a));
              return t;
            })(window),
            n = r,
            a = e,
